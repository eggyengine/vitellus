...
pub const types = struct {
    ...
    const bind_group_layout = @import("types/bind_group_layout.zig");
    const bind_group = @import("types/bind_group.zig");
    const pipeline_layout = @import("types/pipeline_layout.zig");
...
pub const BindGroupLayout = types.bind_group_layout.BindGroupLayout;
pub const BindGroup = types.bind_group.BindGroup;
pub const PipelineLayout = types.pipeline_layout.PipelineLayout;
