...
pub fn mapBuffer(_: *anyopaque, value: resource.Buffer, mode: resource.MapMode, range: resource.BufferRange) anyerror![]u8 {
...
pub fn unmapBuffer(_: *anyopaque, value: resource.Buffer, written: ?resource.BufferRange) void {
    const self = Dx12Buffer.fromHandle(value) catch return;
...
pub fn destroyTexture(_: *anyopaque, value: resource.Texture) void {
...
fn defaultViewDimension(dimension: resource.TextureDimension, layers: u32) resource.TextureViewDimension {
    return switch (dimension) { .d1 => if (layers == 1) .d1 else .d1_array, .d2 => if (layers == 1) .d2 else .d2_array, .d3 => .d3 };
}
...
fn renderTargetViewDesc(format: dx.DXGI_FORMAT, dimension: resource.TextureViewDimension, mip: u32, base_layer: u32, layers: u32) dx.D3D12_RENDER_TARGET_VIEW_DESC {
    ...
    switch (dimension) {
        .d1 => { result.ViewDimension = dx.D3D12_RTV_DIMENSION_TEXTURE1D; result.unnamed_0.Texture1D.MipSlice = mip; },
        .d1_array => { result.ViewDimension = dx.D3D12_RTV_DIMENSION_TEXTURE1DARRAY; result.unnamed_0.Texture1DArray = .{ .MipSlice = mip, .FirstArraySlice = base_layer, .ArraySize = layers }; },
        .d2 => { result.ViewDimension = dx.D3D12_RTV_DIMENSION_TEXTURE2D; result.unnamed_0.Texture2D = .{ .MipSlice = mip, .PlaneSlice = 0 }; },
        .d2_array, .cube, .cube_array => { result.ViewDimension = dx.D3D12_RTV_DIMENSION_TEXTURE2DARRAY; result.unnamed_0.Texture2DArray = .{ .MipSlice = mip, .FirstArraySlice = base_layer, .ArraySize = layers, .PlaneSlice = 0 }; },
        .d3 => { result.ViewDimension = dx.D3D12_RTV_DIMENSION_TEXTURE3D; result.unnamed_0.Texture3D = .{ .MipSlice = mip, .FirstWSlice = base_layer, .WSize = layers }; },
    }
    return result;
}
...
fn depthStencilViewDesc(format: dx.DXGI_FORMAT, dimension: resource.TextureViewDimension, mip: u32, base_layer: u32, layers: u32) dx.D3D12_DEPTH_STENCIL_VIEW_DESC {
    ...
    switch (dimension) {
        .d1 => { result.ViewDimension = dx.D3D12_DSV_DIMENSION_TEXTURE1D; result.unnamed_0.Texture1D.MipSlice = mip; },
        .d1_array => { result.ViewDimension = dx.D3D12_DSV_DIMENSION_TEXTURE1DARRAY; result.unnamed_0.Texture1DArray = .{ .MipSlice = mip, .FirstArraySlice = base_layer, .ArraySize = layers }; },
        .d2 => { result.ViewDimension = dx.D3D12_DSV_DIMENSION_TEXTURE2D; result.unnamed_0.Texture2D.MipSlice = mip; },
        .d2_array, .cube, .cube_array => { result.ViewDimension = dx.D3D12_DSV_DIMENSION_TEXTURE2DARRAY; result.unnamed_0.Texture2DArray = .{ .MipSlice = mip, .FirstArraySlice = base_layer, .ArraySize = layers }; },
        .d3 => {},
    }
    return result;
}

pub fn destroyTextureView(ptr: *anyopaque, value: resource.TextureView) void {
    const device: *Dx12Device = @ptrCast(@alignCast(ptr));
...
pub fn bytesPerPixel(format: resource.Format) ?u64 {
    return switch (format) {
        ...
        .rgba8_unorm, .rgba8_snorm, .rgba8_uint, .rgba8_sint, .rgba8_unorm_srgb, .bgra8_unorm, .bgra8_unorm_srgb,
        .rg16_unorm, .rg16_snorm, .rg16_uint, .rg16_sint, .rg16_float, .r32_uint, .r32_sint, .r32_float,
        .rgb10a2_unorm, .rg11b10_float, .d24_unorm_s8_uint, .d32_float => 4,
        ...
        .bc1_rgba_unorm, .bc1_rgba_unorm_srgb, .bc2_rgba_unorm, .bc2_rgba_unorm_srgb, .bc3_rgba_unorm, .bc3_rgba_unorm_srgb,
        .bc4_r_unorm, .bc4_r_snorm, .bc5_rg_unorm, .bc5_rg_snorm, .bc6h_rgb_ufloat, .bc6h_rgb_float, .bc7_rgba_unorm, .bc7_rgba_unorm_srgb => null,
    };
}
...
pub fn toDxFormat(format: resource.Format) dx.DXGI_FORMAT {
    return switch (format) {
        ...
        .r8_snorm => dx.DXGI_FORMAT_R8_SNORM, .r8_uint => dx.DXGI_FORMAT_R8_UINT, .r8_sint => dx.DXGI_FORMAT_R8_SINT,
        .rg8_unorm => dx.DXGI_FORMAT_R8G8_UNORM,
        .rg8_snorm => dx.DXGI_FORMAT_R8G8_SNORM, .rg8_uint => dx.DXGI_FORMAT_R8G8_UINT, .rg8_sint => dx.DXGI_FORMAT_R8G8_SINT,
        .rgba8_unorm => dx.DXGI_FORMAT_R8G8B8A8_UNORM,
        .rgba8_snorm => dx.DXGI_FORMAT_R8G8B8A8_SNORM, .rgba8_uint => dx.DXGI_FORMAT_R8G8B8A8_UINT, .rgba8_sint => dx.DXGI_FORMAT_R8G8B8A8_SINT,
        ...
        .r16_unorm => dx.DXGI_FORMAT_R16_UNORM, .r16_snorm => dx.DXGI_FORMAT_R16_SNORM, .r16_uint => dx.DXGI_FORMAT_R16_UINT, .r16_sint => dx.DXGI_FORMAT_R16_SINT,
        .rg16_float => dx.DXGI_FORMAT_R16G16_FLOAT,
        .rg16_unorm => dx.DXGI_FORMAT_R16G16_UNORM, .rg16_snorm => dx.DXGI_FORMAT_R16G16_SNORM, .rg16_uint => dx.DXGI_FORMAT_R16G16_UINT, .rg16_sint => dx.DXGI_FORMAT_R16G16_SINT,
        .rgba16_float => dx.DXGI_FORMAT_R16G16B16A16_FLOAT,
        .rgba16_unorm => dx.DXGI_FORMAT_R16G16B16A16_UNORM, .rgba16_snorm => dx.DXGI_FORMAT_R16G16B16A16_SNORM, .rgba16_uint => dx.DXGI_FORMAT_R16G16B16A16_UINT, .rgba16_sint => dx.DXGI_FORMAT_R16G16B16A16_SINT,
        .r32_float => dx.DXGI_FORMAT_R32_FLOAT,
        .r32_uint => dx.DXGI_FORMAT_R32_UINT, .r32_sint => dx.DXGI_FORMAT_R32_SINT,
        .rg32_float => dx.DXGI_FORMAT_R32G32_FLOAT,
        .rg32_uint => dx.DXGI_FORMAT_R32G32_UINT, .rg32_sint => dx.DXGI_FORMAT_R32G32_SINT,
        .rgb32_float => dx.DXGI_FORMAT_R32G32B32_FLOAT,
        .rgb32_uint => dx.DXGI_FORMAT_R32G32B32_UINT, .rgb32_sint => dx.DXGI_FORMAT_R32G32B32_SINT,
        .rgba32_float => dx.DXGI_FORMAT_R32G32B32A32_FLOAT,
        .rgba32_uint => dx.DXGI_FORMAT_R32G32B32A32_UINT, .rgba32_sint => dx.DXGI_FORMAT_R32G32B32A32_SINT,
        .rgb10a2_unorm => dx.DXGI_FORMAT_R10G10B10A2_UNORM,
        .rg11b10_float => dx.DXGI_FORMAT_R11G11B10_FLOAT,
        .bc1_rgba_unorm => dx.DXGI_FORMAT_BC1_UNORM, .bc1_rgba_unorm_srgb => dx.DXGI_FORMAT_BC1_UNORM_SRGB,
        .bc2_rgba_unorm => dx.DXGI_FORMAT_BC2_UNORM, .bc2_rgba_unorm_srgb => dx.DXGI_FORMAT_BC2_UNORM_SRGB,
        .bc3_rgba_unorm => dx.DXGI_FORMAT_BC3_UNORM, .bc3_rgba_unorm_srgb => dx.DXGI_FORMAT_BC3_UNORM_SRGB,
        .bc4_r_unorm => dx.DXGI_FORMAT_BC4_UNORM, .bc4_r_snorm => dx.DXGI_FORMAT_BC4_SNORM,
        .bc5_rg_unorm => dx.DXGI_FORMAT_BC5_UNORM, .bc5_rg_snorm => dx.DXGI_FORMAT_BC5_SNORM,
        .bc6h_rgb_ufloat => dx.DXGI_FORMAT_BC6H_UF16, .bc6h_rgb_float => dx.DXGI_FORMAT_BC6H_SF16,
        .bc7_rgba_unorm => dx.DXGI_FORMAT_BC7_UNORM, .bc7_rgba_unorm_srgb => dx.DXGI_FORMAT_BC7_UNORM_SRGB,
